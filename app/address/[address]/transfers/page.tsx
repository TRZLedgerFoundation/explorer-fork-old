...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return {
        description: `History of all token transfers involving the address ${props.params.address} on Trezoa`,
        title: `Transfers | ${await getReadableTitleFromAddress(props)} | Trezoa`,
    };
}
